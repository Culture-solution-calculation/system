...
public class TypeTabController {
    ...
    public void initialize() {
        ...
        comboBox.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            updateTableViewByCrop(newValue);
        });
    ...
    private void updateTableView(String newValue) {
        ObservableList<String[]> compositionData = TypeData.getAllCompositionData(newValue);
    ...
    private void updateTableViewByCrop(String newValue) {
        String selectedValue = listView.getSelectionModel().getSelectedItem();
        ObservableList<String[]> compositionData = TypeData.getCompositionData(selectedValue, newValue);
